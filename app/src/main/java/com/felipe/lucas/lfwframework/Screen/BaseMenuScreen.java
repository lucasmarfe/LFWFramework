...
public class BaseMenuScreen extends BaseScreen {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        ListView v_ListMenu = new ListView(m_Context);
        v_ListMenu.setBackgroundColor(ContextCompat.getColor(m_Context, R.color.yellow_Scheme));
        v_ListMenu.setLayoutParams(m_LayoutParams);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout
                .simple_list_item_1, contacts);
        v_ListMenu.setAdapter(adapter);
        registerForContextMenu(v_ListMenu);
        m_IFrame.add(v_ListMenu);
        m_IFrame.builScreen();
